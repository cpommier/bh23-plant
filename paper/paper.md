...
Harrow J, Hancock J, ELIXIR-EXCELERATE Community, et al. (2021) ELIXIR-EXCELERATE: establishing Europe’s data infrastructure for the life science research of the future. The EMBO journal 40(6), e107409. doi:10.15252/embj.2020107409

Kajiya-Kanegae H, Matsushita K, Hayashi T, et al. (2022) Pedigree Finder: A web-based crop pedigree viewer for graph databases. Breeding Research 24(2), 115–123. doi:10.1270/jsbbr.22J02

Papoutsoglou EA, Faria D, Arend D, et al. (2020) Enabling reusability of plant phenomic datasets with MIAPPE 1.1. The New phytologist 227(1), 260–273. doi:10.1111/nph.16544

Selby P, Abbeloos R, Backlund JE, et al. (2019) BrAPI—an application programming interface for plant breeding applications. Bioinformatics 35(20), 4147–4155. doi:10.1093/bioinformatics/btz190
